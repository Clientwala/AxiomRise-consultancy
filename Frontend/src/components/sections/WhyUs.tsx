  ...
  return (
    <section className="section-padding bg-primary">
      <div className="container-max text-center">
        <SectionHeading centered eyebrow="Why Partner With Axiom Rise" title="Turning Partnerships into Possibilities" subtitle="We work as an extension of your team — taking the time to understand your business, your culture, and your hiring requirements so we can deliver practical and effective talent solutions." className="[&_.eyebrow]:text-accent [&_.section-title]:text-white [&_.section-subtitle]:text-white/70" />
