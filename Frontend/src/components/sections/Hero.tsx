    ...
    <section className="relative bg-soft overflow-hidden pt-24 md:pt-28">
      <div className="container-max px-6 lg:px-20 xl:px-28 py-12 md:py-16 lg:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          {/* Left Content */}
          <div>
            <motion.p custom={0} initial="hidden" animate="visible" variants={fadeUp} className="eyebrow">Singapore &bull; Management Consultancy</motion.p>
            ...
            <motion.p custom={2} initial="hidden" animate="visible" variants={fadeUp} className="text-muted text-base md:text-lg mt-6 max-w-lg leading-relaxed">
              A Singapore-incorporated executive advisory and management consultancy — connecting exceptional professionals with leading organizations to accelerate sustainable growth.
            </motion.p>
