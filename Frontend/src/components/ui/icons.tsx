...
export const BoltIcon = (p: IconProps) => (
  <Svg {...p}>
    <path d="M13.4 2.5 5.2 13.4c-.3.4 0 .9.5.9h4.6l-1.4 7.1c-.1.5.5.8.8.4l8.5-10.1c.4-.5 0-1.1-.5-1.1h-4.4l1.2-6.9c.1-.5-.3-.9-.8-.9z" />
    <path d="M10.8 7.2c.5 1.3 1.2 2 2 2.7" opacity={0.4} />
  </Svg>
);

export const ShieldIcon = (p: IconProps) => (
  <Svg {...p}>
    <path d="M12 2.9c.8.5 4.4 2 6.2 2.9v5.4c0 4.5-2.9 7.7-6.2 9.1-3.3-1.4-6.2-4.6-6.2-9.1V5.8c1.8-.9 5.4-2.4 6.2-2.9z" />
    <path d="M8.9 11.9l2.1 2.2 4-4.3" />
    <path d="M5.9 8.6c1.2.5 2.4 1 3.6 1.6" opacity={0.35} />
  </Svg>
);

export const HeartIcon = (p: IconProps) => (
  <Svg {...p}>
    <path d="M12 19.9C6.7 16.6 4.7 13 4.7 9.9c0-2.3 1.8-4.1 4.1-4.1 1.3 0 2.5.6 3.2 1.7.7-1.1 1.9-1.7 3.2-1.7 2.3 0 4.1 1.8 4.1 4.1 0 3.1-2 6.7-7.3 10z" />
    <path d="M7 8.6c.5.4 1 .7 1.5.9" opacity={0.35} />
  </Svg>
);
