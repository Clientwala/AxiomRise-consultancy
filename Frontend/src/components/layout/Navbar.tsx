      ...
      <div className="container-max flex items-center justify-between h-20 md:h-24 px-6 lg:px-20 xl:px-28">
        <Link href="/" className="flex items-center gap-3 shrink-0">
          <span className="inline-flex items-center justify-center bg-primary rounded-full p-0.5 shrink-0">
            <Image src="/logo/axiomrise-logo.png" alt="Axiom Rise Consultancy" width={220} height={220} className="h-10 md:h-12 w-auto" priority />
          </span>
          <span className="leading-tight">
            <span className="block font-serif font-semibold text-primary text-xl md:text-2xl tracking-tight">Axiom Rise</span>
            <span className="block text-[8px] md:text-[9px] font-medium text-muted uppercase tracking-[0.16em] md:tracking-[0.2em]">Advisory Excellence</span>
          </span>
        </Link>
